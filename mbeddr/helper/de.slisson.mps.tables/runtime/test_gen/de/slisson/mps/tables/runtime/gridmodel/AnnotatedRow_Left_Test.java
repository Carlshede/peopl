...
public class AnnotatedRow_Left_Test extends TestCase {
  private Grid row0;
  private Grid row1;
  private Grid row2;
  ...
  public void test_annotation_column_other_rows() throws Exception {
    Assert.assertEquals(UnusedPosition.class, gridMain.getElement(0, 0).getClass());
    Assert.assertEquals(UnusedPosition.class, gridMain.getElement(0, 2).getClass());
  }
  public void setUp() {
    row0 = new Grid();
    row1 = new Grid();
    ...
    annotatedRow1.setElement(1, 0, row1);
    annotatedRow1.setAlignmentShiftLeft(1);
