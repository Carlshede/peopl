...
public class Statemachine_Test extends TestCase {
  private Grid main;
  private Grid g00;
  private Grid g01;
  private Grid g10;
  ...
  public void test_column_headers() throws Exception {
    Assert.assertEquals(event0, main.getColumnHeader(0, 0));
    Assert.assertEquals(event1, main.getColumnHeader(1, 0));
  }
  public void test_row_headers() throws Exception {
    Assert.assertEquals(state0, main.getRowHeader(0, 0));
    Assert.assertEquals(state1, main.getRowHeader(0, 1));
  }
  public void setUp() {
    main = new Grid();
    g00 = new Grid();
    ...
    main.setElement(0, 0, g00);
    main.setElement(1, 0, g10);
    main.setElement(0, 1, g01);
    main.setElement(1, 1, g11);
    main.setColumnHeader(0, 0, event0);
    main.setColumnHeader(1, 0, event1);
    main.setRowHeader(0, 0, state0);
    main.setRowHeader(0, 1, state1);
