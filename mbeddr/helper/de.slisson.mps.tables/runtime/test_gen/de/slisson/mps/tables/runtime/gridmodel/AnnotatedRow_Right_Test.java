...
public class AnnotatedRow_Right_Test extends TestCase {
  private Grid row0;
  private Grid row1;
  private Grid row2;
  ...
  public void test_annotation_position() throws Exception {
    Assert.assertSame(annotation, gridMain.getElement(3, 1));
  }
  public void setUp() {
    row0 = new Grid();
    row1 = new Grid();
    ...
    row1.setSpanX(row1.getSizeX());
    annotatedRow1.setElement(0, 0, row1);
    annotatedRow1.setElement(row1.getSizeX(), 0, annotation);
