...
<solution name="peopl.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#peopl.__spreferences.TypeSizeConfiguration" moduleVersion="0" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    <module reference="~_PreferencesModule#peopl.__spreferences.TypeSizeConfiguration(peopl.__spreferences.TypeSizeConfiguration)" version="0" />
  </dependencyVersions>
</solution>
